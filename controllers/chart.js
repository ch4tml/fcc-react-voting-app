...
//     Poll.findOneAndUpdate({"polls.poll.url": req.params[0]}, { $inc: { "polls.poll.dataset.data": 1 }}, function (err, poll) {
//         if (err) throw err;
//         else if(poll === undefined || poll === null)
//             res.send(JSON.stringify({"error": "unable to find poll"}));
//         else{
//             console.log(poll);
//             //console.log(poll.dataset.data[0]);
//             console.log("Found document, updating...");
//             res.send(poll);
//         }
//         res.end();
//     });
